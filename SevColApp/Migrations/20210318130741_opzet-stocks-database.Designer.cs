...
namespace SevColApp.Migrations
{
    ...
    [Migration("20210318130741_opzet-stocks-database")]
    partial class opzetstocksdatabase
    {
            ...
            modelBuilder.Entity("SevColApp.Models.StockExchangeSellRequest", b =>
                {
                    ...
                    b.Property<int>("MinimumPerStock")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SevColApp.Models.UserCompanyStocks", b =>
                {
                    ...
                    b.Property<int>("NumberOfStocksOwned")
                        .HasColumnType("int");
