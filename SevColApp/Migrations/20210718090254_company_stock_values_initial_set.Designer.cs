...
namespace SevColApp.Migrations
{
    ...
    [Migration("20210718090254_company_stock_values_initial_set")]
    partial class company_stock_values_initial_set
    {
            ...
            modelBuilder.Entity("SevColApp.Models.Company", b =>
                {
                    ...
                    b.Property<float>("CompanyTrendFactor")
                        .HasColumnType("real");

                    b.Property<float>("CompanyVolatility")
                        .HasColumnType("real");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CompanyTrendFactor = 1f,
                            CompanyVolatility = 0.6f,
                            Name = "Endeavour",
                            NumberOfStocks = 0
                        },
                        new
                        ...
                        new
                        {
                            Id = 12,
                            CompanyTrendFactor = 1f,
                            CompanyVolatility = 1.12f,
                            Name = "New Luna Jones",
                            NumberOfStocks = 0
                        });
                });

            modelBuilder.Entity("SevColApp.Models.Global", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<float>("MarketTrendFactor")
                        .HasColumnType("real");

                    b.Property<float>("MarketVolatility")
                        .HasColumnType("real");
